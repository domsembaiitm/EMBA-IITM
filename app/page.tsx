...
export default async function Home() {
  ...
  // Fallback stats (better to cache these or keep hardcoded for pure static speed if needed)
  // For now, hardcoding reasonable estimates to avoid heavy DB aggregations on home
  const avgExperience = 15
  const totalStudents = 49 // From seed
